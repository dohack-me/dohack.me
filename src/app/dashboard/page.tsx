    ...
    return (
        <div className={"grow padding column"}>
            <Card>
                <CardHeader>
                    <CardTitle
                        className={"text-center"}>Welcome, {(session.user && session.user.name) ? session.user.name : "User"}!</CardTitle>
                    <CardDescription className={"text-center"}>Here&apos;s a random challenge for you to
                        try.</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <div className={"grid grid-cols-1 xl:grid-cols-2 gap-8"}>
                ...
                <Card className={"flex flex-col"}>
                    <CardHeader>
                        ...
                        <CardDescription>Return to bookmarked challenges and challenges with active
                            instances.</CardDescription>
                    </CardHeader>
